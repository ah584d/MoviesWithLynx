...
import type {IMovie} from './Type.js';
        ...
        <view className='MainContent'>
          <view className='Header'>
            ...
            <view className="FilterSection">
              ...
              <view className="FilterOptions">
                <view
                  className={!useHighestRated ? 'FilterButtonActive' : 'FilterButton'}
                  bindtap={handleActionRecommend}
                >
                  <text>Random</text>
                </view>
                <view
            ...
            >
              {displayedMovies.map((movie, index) => {
                return (
                  ...
                  >
                    <view className={index % 2 === 0 ? 'ItemBgOdd' : ''} style="width:100%;border-bottom:1px solid #ccc">
                      ...
                      <view className='PosterContainer'>
                        <image
                          src={`https://image.tmdb.org/t/p/w342${movie.poster_path || movie.poster_path}`}
